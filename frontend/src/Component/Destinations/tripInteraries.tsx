...
const DayTripSlider = () => {
  ...
  return (
    <div className="bg-white py-7 px-4 sm:px-6 xl:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="mt-2 text-black font-semibold text-2xl md:[24px] lg:text-[28px]">
        ...
        {currentCard && (
          <div className="mt-10 flex flex-col sm:flex-row bg-white border shadow-md rounded-xl overflow-hidden max-w-[1000px] mx-auto transition-all duration-500">
            ...
            <div className="p-4 lg:p-6 text-left w-full sm:w-1/2">
              <h3 className="text-[28px] lg:[36px] xl:text-[40px] leading-tight font-playfair font-semibold text-blue mb-3">
