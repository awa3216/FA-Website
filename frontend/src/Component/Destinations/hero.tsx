    ...
    <div>
      ...
      <div className="bg-[url('/images/hero.png')] bg-cover bg-center bg-no-repeat min-h-[30vh] md:min-h-[40vh] lg:min-h-[58vh] flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="text-center flex flex-col justify-center items-center">
          <p className="text-white font-extrabold font-playfair text-[20px] md:text-[24px] xl:text-[28px]">
            DESTINATIONS
          </p>
      ...
      <p className="text-center text-[#034250] font-sourceSansPro text-base sm:text-lg md:text-xl font-normal max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-12 leading-relaxed">
